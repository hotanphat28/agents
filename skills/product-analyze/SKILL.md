...
- Generate rich PRDs, BRDs, and Strategic Briefs.
...
**Theming:** All diagrams MUST apply and match the theme used for the HTML documents (e.g., matching colors and fonts).

**Mapping:**
- **User Journey / Process Flow:** Activity Diagrams
- **System Integrations:** Sequence Diagrams
- **Architecture:** Component Diagrams or C4 Model
