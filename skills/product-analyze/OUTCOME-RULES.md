...
* Key decisions with rationale, use `<>` (Decision block) to highlight the decision and rationale, ensure adding date with format YYYY-MM-DD.
...
## Workflow
Upload the diagram SVG or PNG file to the Confluence page and embed it here.
